...
macro(find_pkg ARG_ALIASES)
	...
	set(FIND_PACKAGE_MODULE_ARGUMENTS ${FIND_PACKAGE_ARGUMENTS})
	list(REMOVE_ITEM FIND_PACKAGE_MODULE_ARGUMENTS "PATHS" ${FIND_PACKAGE_PATHS})
	...
	foreach(ALIAS ${ALIASES})
		...
		if(FIND_PACKAGE_COMPONENTS)
			foreach(COMPONENT ${FIND_PACKAGE_COMPONENTS})
				...
				if(NOT ${NAME}_FOUND)
					find_package(${NAME} ${FIND_PACKAGE_VERSION} COMPONENTS ${COMPONENT} ${FIND_PACKAGE_MODULE_ARGUMENTS} ${QUIET_STR} MODULE ${FIND_PACKAGE_UNPARSED_ARGUMENTS})
				endif()
			...
			if(NOT ${NAME}_FOUND)
				find_package(${NAME} ${FIND_PACKAGE_MODULE_ARGUMENTS} ${QUIET_STR} MODULE ${FIND_PACKAGE_UNPARSED_ARGUMENTS})
				if(NOT ${NAME}_FOUND)
